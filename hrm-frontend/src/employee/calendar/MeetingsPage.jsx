// src/employee/meetings/MeetingsPage.jsx
import React, { useState, useEffect, useCallback } from "react";
import {
  Video, Search, Clock, MapPin, Users, Calendar,
  MoreHorizontal, Link, CheckCircle, XCircle,
  Play, Copy, Filter, ChevronDown
} from "lucide-react";
import axios from "axios";
import Sidebar from "../../layouts/sidebar";
import MobileTopBar from "../../employee/MobileTopBar";
import { useTheme } from "../../context/ThemeContext";
import MeetingDetails from "../../admin/meetings/MeetingDetails";
      ...
      <div style={{
        ...
        <div className="meeting-topbar" style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "12px", flex: 1 }}>
            ...
            <h1 style={{ fontSize: "1rem", fontWeight: "600", color: t.textPrimary, margin: 0 }}>My Meetings</h1>
          </div>
        </div>
